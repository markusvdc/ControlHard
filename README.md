...
| SABER ENCANTADO | Ao segurar Shift, exibe descrição e equipamentos em Livros encantados com exatamente um encantamento; livros com vários não recebem dados. Na Mesa de encantamentos, exibe as informações somente com o nível necessário, após os custos e uma linha vazia. Ambos os tooltips possuem largura máxima de 600 px. |
